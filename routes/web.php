...
Route::get('/position/create', [PositionController::class, 'create'])->name('position.create')->middleware('auth');
Route::get('/position/edit/{position}', [PositionController::class, 'edit'])->name('position.edit')->middleware('auth');
